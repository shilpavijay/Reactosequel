...
A React App - An interface to perform Create, Read, Delete, Update - CRUD operations on the Database. I am using a RESTful API server, built as a separate project to Interact with the MySQL database.
Lint to REST-API server Project : https://github.com/shilpavijay/REST-API-CRUD-Ops
